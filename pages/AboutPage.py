    ...
    with theme.frame('About'):
        ...
        with ui.grid(columns=2).classes('first_section'):
            ...
            with ui.column().classes('w-2/3 p-4'):
                ui.label('A propos de moi').classes('text-center text-white text-4xl font-semibold pt-4')
                ui.label('Bienvenue sur mon portfolio !').classes('text-bold text-white text-lg')
                ui.label("""
                ...
                ui.button('Mon CV', on_click=lambda: ui.download('/assets/downloads/README.md')).classes('bg-blue-500 text-white text-md px-8 py-3 rounded-lg hover:bg-blue-600 focus:outline-none focus:bg-blue-600')
